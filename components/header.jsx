    ...
    return (
        ...
        <Navbar>
            <a className="flex items-center hovesr:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
                ...
                <span className="max-md:hidden select-none font-extrabold ltr:ml-2 rtl:mr-2" title="CiteGraph.github.io: Gesture Generation Research Community">CiteGraph.github.io</span>
            </a>
            ...
            <a href="https://CiteGraph.github.io/" target="blank" rel="blank" className=" contrast-more:text-gray-700 contrast-more:dark:text-gray-100 max-md:hidden whitespace-nowrap text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" aria-current="false">CiteGraph ↗</a>
            <a href="https://github.com/CiteGraph" target="blank" rel="noreferrer">
                <Github />
                <span className="sr-only">GitHub</span>
            </a>
            <a href="https://twitter.com/CiteGraphai" target="blank" rel="noreferrer">
                <Twitter />
            </a>
        </Navbar>
        //     </nav>
