...
const MenuItem = ({ item, level = 0 }) => {
    ...
    const commonClasses = "flex rounded px-2 py-1.5 text-sm transition-colors [word-break:break-word] cursor-pointer [-webkit-tap-highlight-color:transparent] [-webkit-touch-callout:none] contrast-more:border " + 
        (isActive 
        ...
        return (
            <li>
                <div className="flex items-center">
                    ...
                    <button
                        onClick={() => setIsOpen(!isOpen)}
                        className="p-1 hover:bg-gray-100 dark:hover:bg-primary-100/5 rounded-md"
                    >
                        <svg
                            fill="none"
                            viewBox="0 0 24 24"
                ...
                >
                    <div className={"transition-opacity duration-500 ease-in-out motion-reduce:transition-none " + (isOpen ? 'opacity-100' : 'opacity-0') + " ltr:pr-0 rtl:pl-0 pt-1"}>
